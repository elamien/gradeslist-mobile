...
export interface UniversalAssignment {
  ...
  course_id?: string;            // Course ID for filtering
  course_name?: string;          // Optional course name for display
  platform?: 'canvas' | 'gradescope' | 'blackboard' | 'google-classroom' | 'moodle'; // Source platform
}
